...
// Define the bubble chart component
const Bubble = () => {
  ...
  const optionsData = {
    ...
    legend: {
      right: 10,
      data: ["1990", "2015"], // Update legend names to match years
    },
    xAxis: {
      splitLine: {
        lineStyle: {
    ...
    series: [
      {
        name: "1990", // Update series name to match year
        data: data[0],
        type: "scatter",
      ...
      {
        name: "2015", // Update series name to match year
        data: data[1],
        type: "scatter",
        symbolSize: function (data) {
          return Math.sqrt(data[2]) / 5e2;
  ...
  // Return the component with ReactEcharts
  return (
    <React.Fragment>
